...
export const getBookById = async (bookid) => {
 ...
 export const createBookWithGenres = async (bookData, genres, covers) => {
    ...
    const mainCover = `data:${covers[0].mimetype};base64,${covers[0].buffer.toString('base64')}`;
    const coverArt = `data:${covers[1].mimetype};base64,${covers[1].buffer.toString('base64')}`;
        ...
        try {
           ...
           console.log(genres);
            ...
            for (let key in bookData) {
                ...
                if (typeof bookData[key] === 'string') {  // https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/typeof
            ...
            const genresToRemove = book.Genres.filter(existingGenre => 
                genresOld.includes(existingGenre.name) // https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/includes
            );
